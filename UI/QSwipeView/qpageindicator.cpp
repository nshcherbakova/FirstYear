...
QPageIndicator::QPageIndicator(QWidget *parent)
...
QPageIndicator::QPageIndicator(int count, QWidget *parent)
    : QWidget(parent), currentPage(0) {
...
int QPageIndicator::getCurrentPage() const { return currentPage; }
...
int QPageIndicator::getPageCount() const { return pageButtons.size(); }
