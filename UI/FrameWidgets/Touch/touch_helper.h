...
struct Touch {
  // a little delay in the begin of the gesture, to get more data of the touch
  // points moving so the recognizing of the pan gesture is better
  ...
  // how long must a touch point be stationary, before he can move for a
  // TabHoldAndMoving gesture
  static const int durationForTapHold = 400;
  // in what time and how far must the touch point moving to trigger a swipe
  // gesture
...
QPoint simpleTapPosition(QEvent *);
QPoint simpleTouchPosition(QEvent *, int = 0);
bool touchStationary(QEvent *);
