...
ANDROID_VERSION_CODE_LOW = "22"

contains(ANDROID_TARGET_ARCH,arm64-v8a) {
    ANDROID_VERSION_CODE_HI = "064"
}
contains(ANDROID_TARGET_ARCH,armeabi-v7a) {
    ANDROID_VERSION_CODE_HI="032"
}

contains(ANDROID_TARGET_ARCH,x86) {
    ANDROID_VERSION_CODE_HI = "086"
}

contains(ANDROID_TARGET_ARCH,x86_64) {
    ANDROID_VERSION_CODE_HI = "087"
}

ANDROID_VERSION_NAME = "1.0"
ANDROID_VERSION_NAME = $${ANDROID_VERSION_NAME}$${ANDROID_VERSION_CODE_LOW}
ANDROID_VERSION_CODE=$${ANDROID_VERSION_CODE_HI}$${ANDROID_VERSION_CODE_LOW}
